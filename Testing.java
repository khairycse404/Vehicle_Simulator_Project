...
public class Testing extends Application {
    ...
    private static final int MOTO_COUNT = 0;
    ...
    private static final int BOAT_COUNT = 1;
    ...
    public void start(Stage stage) throws Exception {
        ...
        for (int i = 0; i < HELICOPTER_COUNT; i++) {
            ...
            allVehicles.add(
                    new Helicopter.Builder()
                            ...
                            .setCenterY(spawn[1] + (i * AIR_Y_SPACING) - AIR_Y_SPACING / 2)
                            .setCenterZ(0)
                            .setMass(HELICOPTER_MASS)
                            .speed(HELICOPTER_SPEED)
                            .direction(0)
                            .vZ(HELICOPTER_VZ)
                            .acceleration(HELICOPTER_ACCEL)
                            .build()
            );
        }
        ...
        Timeline animation = new Timeline(
                new KeyFrame(
                        Duration.millis(Movable.ANIMATION_PERIODIC_TIME),
                        e -> {
